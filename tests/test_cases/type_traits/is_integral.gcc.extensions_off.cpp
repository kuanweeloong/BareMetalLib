...
{
    // META: Check that this test is only compiled with GNU extensions disabled.
    {
    ...
    // Check that the result is false for __int128_t and __uint128_t when they're available, since
    // GNU extensions are disabled.
    {
        #if defined(__SIZEOF_INT128__)
            check_not_integral<__int128_t>();
            check_not_integral<__uint128_t>();
        #endif
    }
